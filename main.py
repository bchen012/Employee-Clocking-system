...
import pandas as pd
# values_to_add = pd.DataFrame({'Employee ID': ['123'], 'Employee Name': ['bbb'], 'Clocked In': ["no"]})
# values_to_add.to_csv("employee_data.csv")
...
employeeMgr.save_date_to_files()    #save the data to attendance.txt and employee_data